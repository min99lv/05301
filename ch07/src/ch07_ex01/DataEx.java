...
class Data {
	...
	// void : 리턴값을 주지 않겠다는 의미 -> 알아서 리턴하겠다
	void addRef (Data d1, Data d2)	{		// 메소드 
		d1.kor = d2.eng;
		System.out.println("mehod국어점수 :"+d1.kor);
	}
	
	// Return type = int  Return method parameter = addKor (int Kor)
	// 리턴할때 인트타입으로 돌려주겠다
	int addKor (int kor) {
		kor += 10;
...
public class DataEx {
	...
	public static void main(String[] args) {
		...
		Data d2 = new Data();
		Data d3 = new Data();
//		int d3_kor = d3.addKor(10);    // 메소드를 실행시킨 결과를 d3_kor로 받는다
...
// 콜바이밸류는 자료형 하나밖에 못 리턴한다 보이드는 아무것도 못가져온다.